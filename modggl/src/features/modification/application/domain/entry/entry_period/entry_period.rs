...
mod tests {
    ...
    #[rstest(
        ...
        case(
            EntryStart::new(utils::generate_datetime("2022-01-01T09:00:00+00:00")),
            EntryEnd::new(utils::generate_datetime("2022-01-01T12:00:00+00:00")),
        ),
        case(
            EntryStart::new(utils::generate_datetime("2022-01-01T09:00:00+00:00")),
            EntryEnd::new(utils::generate_datetime("2022-01-01T09:00:00+00:00")),
        ),
        #[should_panic]
        case(
            EntryStart::new(utils::generate_datetime("2022-01-01T12:00:01+00:00")),
            EntryEnd::new(utils::generate_datetime("2022-01-01T12:00:00+00:00")),
        ),
        #[should_panic]
        case(
            EntryStart::new(utils::generate_datetime("2022-01-02T09:00:00+00:00")),
            EntryEnd::new(utils::generate_datetime("2022-01-01T12:00:00+00:00")),
        ),
    )]
    ...
    #[rstest(first, second, expected,
        case(
            EntryPeriod::new(Props {
                start: EntryStart::new(utils::generate_datetime("2022-01-15T09:00:00+00:00")),
                end: EntryEnd::new(utils::generate_datetime("2022-01-15T12:00:00+00:00")),
            }),
            EntryPeriod::new(Props {
                start: EntryStart::new(utils::generate_datetime("2022-01-15T09:00:00+00:00")),
                end: EntryEnd::new(utils::generate_datetime("2022-01-15T12:00:00+00:00")),
        ...
        case(
            EntryPeriod::new(Props {
                start: EntryStart::new(utils::generate_datetime("2022-01-15T09:00:00+00:00")),
                end: EntryEnd::new(utils::generate_datetime("2022-01-15T09:00:00+00:00")),
            }),
            EntryPeriod::new(Props {
                start: EntryStart::new(utils::generate_datetime("2022-01-15T09:00:00+00:00")),
                end: EntryEnd::new(utils::generate_datetime("2022-01-15T09:00:00+00:00")),
        ...
        case(
            ...
            EntryPeriod::new(Props {
                start: EntryStart::new(utils::generate_datetime("2022-01-15T06:00:00+00:00")),
                end: EntryEnd::new(utils::generate_datetime("2022-01-15T08:00:00+00:00")),
            }),
        ...
        case(
            ...
            EntryPeriod::new(Props {
                start: EntryStart::new(utils::generate_datetime("2022-01-15T15:00:00+00:00")),
                end: EntryEnd::new(utils::generate_datetime("2022-01-15T18:00:00+00:00")),
            }),
            EntryRelation::Less
        ),
        case(
            ...
            EntryPeriod::new(Props {
                start: EntryStart::new(utils::generate_datetime("2022-01-15T12:00:00+00:00")),
                end: EntryEnd::new(utils::generate_datetime("2022-01-15T15:00:00+00:00")),
            }),
            EntryRelation::Less
        ),
        ...
        case(
            ...
            EntryPeriod::new(Props {
                start: EntryStart::new(utils::generate_datetime("2022-01-15T10:00:00+00:00")),
                end: EntryEnd::new(utils::generate_datetime("2022-01-15T13:00:00+00:00")),
            }),
        ...
        case(
            ...
            EntryPeriod::new(Props {
                start: EntryStart::new(utils::generate_datetime("2022-01-15T10:00:00+00:00")),
                end: EntryEnd::new(utils::generate_datetime("2022-01-15T11:00:00+00:00")),
            }),
